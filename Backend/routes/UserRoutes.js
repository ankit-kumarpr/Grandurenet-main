...
Createroom
    ...
    router.put('/deleteadmin/:customer_ref_no' ,auth, role(["SuperAdmin","Admin"]), DeleteAdmin);
    router.get('/alluserlist', auth, role(["SuperAdmin","Admin"]), GetallUsers);
    router.put('/deleteuser/:customer_ref_no' ,auth, role(["SuperAdmin","Admin"]), DeleteAnyUser);
    router.put('/banadmin/:customer_ref_no',auth, role(["SuperAdmin"]), BanAdmin);
    router.put('/unbanadmin/:customer_ref_no',auth, role(["SuperAdmin"]), UnbanAdmin);
