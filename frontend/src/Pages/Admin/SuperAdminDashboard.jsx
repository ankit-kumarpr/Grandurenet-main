...
const SuperAdminDashboard = () => {
  ...
  const fetchUserData = async () => {
    try {
      ...
      const response = await axios.get(
        "https://grandurenet-main.onrender.com/api/user/alluserlist",
        {
          headers: {
  ...
  const fetchAdminData = async () => {
    try {
      ...
      const response = await axios.get(
        "https://grandurenet-main.onrender.com/api/user/getalladmin",
        {
          headers: {
            "Content-Type": "application/json",
            Accept: "application/json",
  ...
  const getBanHistory = async (userId, type) => {
    try {
      ...
      const url = `https://grandurenet-main.onrender.com/api/user/adminbanhistory/${userId}`;
  ...
  const handleBanUser = async () => {
    try {
      ...
      const response = await axios.put(
        `https://grandurenet-main.onrender.com/api/user/userban/${selectedUser._id}`,
        requestBody,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
  ...
  const handleBanAdmin = async () => {
    try {
      ...
      const response = await axios.put(
        `https://grandurenet-main.onrender.com/api/user/banadmin/${selectedAdmin._id}`,
        requestBody,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
  ...
  const handleUnbanUser = async (userId) => {
    try {
      const response = await axios.put(
        `https://grandurenet-main.onrender.com/api/user/unbanuser/${userId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
  ...
  const handleUnbanAdmin = async (adminId) => {
    try {
      const response = await axios.put(
        `https://grandurenet-main.onrender.com/api/user/unbanadmin/${adminId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
