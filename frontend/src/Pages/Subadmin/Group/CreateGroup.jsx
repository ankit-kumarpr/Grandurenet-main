...
const CreateGroup = () => {
  ...
  const CreateGroupAPI = async () => {
    try {
      const url = `https://grandurenet-main.onrender.com/api/user/create-group`;
      const headers = {
  ...
  const AddUserToGroupAPI = async () => {
    try {
      ...
      const url = `https://grandurenet-main.onrender.com/api/user/add-users/${selectedGroup._id}`;
      const headers = {
        "Content-Type": "application/json",
        Accept: "application/json",
        Authorization: `Bearer ${accessToken}`,
  ...
  const RemoveUserFromGroupAPI = async () => {
    try {
      ...
      const url = `https://grandurenet-main.onrender.com/api/user/remove-user/${selectedGroup._id}`;
      const headers = {
        "Content-Type": "application/json",
        Accept: "application/json",
        Authorization: `Bearer ${accessToken}`,
